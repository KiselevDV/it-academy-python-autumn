...
['ab', 'ac', 'ad', 'bb', 'bc', 'bd']. Используйте на предыдущий список
slice чтобы получить следующий: ['ab', 'ad', 'bc']. Используйте
генератор списков чтобы получить следующий ['1a', '2a', '3a', '4a'].
...
"""
7.  Шоколадка‌ ‌имеет‌ ‌вид‌ ‌прямоугольника,‌ ‌разделенного‌ ‌на‌ ‌n×m‌
‌долек. ‌Шоколадку‌ ‌можно‌ ‌один‌ ‌раз‌ ‌разломить‌ ‌по‌ ‌прямой‌ ‌на‌ ‌две
‌части. Определите, ‌можно‌ ‌ли‌ ‌таким ‌образом‌ ‌отломить‌ ‌от‌ ‌шоколадки‌
‌ровно‌ ‌k‌ ‌долек.‌ Определите,‌ ‌можно‌ ‌ли‌ ‌отломить‌ ‌от‌ ‌шоколадки‌ ‌ровно‌
‌k‌ ‌одиночных‌ ‌долек‌ ‌Определите,‌ ‌можно‌ ‌ли‌ ‌отломить‌ ‌от‌ ‌шоколадки
‌ровно‌ ‌k‌ ‌одиночных‌ ‌долек‌ ‌с‌ ‌помощью‌ ‌t‌ ‌разломов.‌ ‌Описание‌
‌решение‌ ‌поместите‌ ‌в‌ ‌docstring
‌"""
# to be continued ...
